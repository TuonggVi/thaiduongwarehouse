...
class LoadGoodsIssuesEvent extends GoodsIssueEvent {
  DateTime timestamp;
  GoodsIssueLot? goodsIssueLot;
  LoadGoodsIssuesEvent(this.timestamp, this.goodsIssueLot) : super(goodsIssueLot);
  @override
...
class PatchRequestQuantityEvent extends GoodsIssueEvent {
  ...
  PatchRequestQuantityEvent(this.timestamp, this.index, this.goodsIssue,) : super(null);
  @override
  List<Object?> get props => [timestamp];
}